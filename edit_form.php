 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_homepage_course_list_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->addElement('text', 'config_title', get_string('configtitle', 'block_homepage_course_list'));
        $mform->setType('config_title', PARAM_TEXT);

        // Instance filters.
        $mform->addElement('textarea',
                        'config_filters',
                        get_string('filters', 'block_homepage_course_list'),
                        array('cols' => 80, 'rows' => 8, 'style' => 'resize: both; font-family: monospace;'));
        $mform->addHelpButton('config_filters', 'filters', 'block_homepage_course_list');
